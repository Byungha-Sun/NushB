...
#Step 2. 원본 파일 불러오기
data1 <- readLines('미세먼지_지식인.txt')#1.이 곳에 적절한 명령을 완성하세요
    head(data1,10)
...
head(sort(wordcount2, decreasing=T),300)
...
getwd( )
savePlot("수험생의수험번호_이름.png" , type="png")

data11 <- head(sort(wordcount2,decreasing = T),40)
write.csv(data11,'20200824.csv')
